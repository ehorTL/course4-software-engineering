        ...
        <b-card v-if="state.edit_opened" header-tag="featured">
          <div>
            ...
            <b-form-input
              ...
              type="text"
            ></b-form-input>
            <b-form-input v-model="reader.surname" type="text"></b-form-input>
            <b-form-input v-model="reader.phone" type="text"></b-form-input>
            <b-form-input v-model="reader.email" type="text"></b-form-input>
